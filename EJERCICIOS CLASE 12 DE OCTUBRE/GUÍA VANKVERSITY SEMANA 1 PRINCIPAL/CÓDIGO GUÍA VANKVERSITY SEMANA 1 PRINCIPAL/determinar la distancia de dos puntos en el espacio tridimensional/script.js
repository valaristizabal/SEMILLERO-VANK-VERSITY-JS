...
/*Realizar un algoritmo para determinar la distancia de dos puntos en el espacio bidimensional*/
    /*ENTRADA DE DATOS*/
     ...
     coordenada_z1 = parseFloat(prompt("Ingrese la coordenada z1"));
     coordenada_z2 = parseFloat(prompt("Ingrese la coordenada z2"));

    /*PROCESO*/

     distancia = Math.sqrt((coordenada_x2 - coordenada_x1)**2 + (coordenada_y2 - coordenada_y1)**2 + (coordenada_z2 - coordenada_z1)**2);
